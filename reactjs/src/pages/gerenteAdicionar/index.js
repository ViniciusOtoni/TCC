                 ...
                 <StyledGerenteAdicionar>
                    ...
                    <div className="content">
                        <div className="line alternating">
                            ...
                            <div className="input"> <StyledInput className="style-input"/> </div>
                        </div>
                        <div className="line">
                        ...
                        <div className="line alternating">
                            ...
                            <div  className="input"> <StyledSelect className="style-input"> <option value="selecione">  selecione </option> </StyledSelect> </div>
                        </div>
                        <div className="line">
                        ...
                        <div className="line alternating">
                            ...
                            <div  className="input"> <StyledInput className="style-input" placeholder="URl da Imagem"/>  </div>
                        </div>
                        <div className="line">
                        ...
                        <div className="line">
                            ...
                            <div  className="input"> <StyledSelect className="style-input">  <option value="selecione">  1 parcela </option> </StyledSelect> </div>
                        </div>
                    </div>
