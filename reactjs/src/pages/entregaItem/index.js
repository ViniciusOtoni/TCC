...
export default function EntregaItem(props) {
    ...
    const [ info, setInfoPedido ] = useState(props.location.state)
                    ...
                    <div className="agp-cima">
                     <div className="row-cima">  
                        <div className="column"> 
                                <div className="icon"> {hiddenCheck(info.ds_situacao, 1)
                        ...
                        <div className="column"> 
                                <div className="icon"> {hiddenCheck(info.ds_situacao, 2)
                        ...
                        <div className="column"> 
                                <div className="icon"> {hiddenCheck(info.ds_situacao, 3)
