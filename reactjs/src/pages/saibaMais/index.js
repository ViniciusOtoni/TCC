    ...
    return (
        ...
        <main style={{ width: "1240px", margin: "auto" }}>
            ...
            <div className="textos">
                ...
                <p className="ultimoP"> A marca pertence ao BUD Group, holding especialista em comércio de games no cenário nacional, provendo ainda mais força e profissionalismo para as atividades. O objetivo maior é oferecer aos clientes uma experiência de compra única, com agilidade, bom atendimento e pós-venda impecável.
