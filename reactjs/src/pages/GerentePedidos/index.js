                      ...
                      <table> 
                          ...
                          <tbody> 
                              <tr style={{backgroundColor:"#282828"}}> 
                                  ...
                                  <td>  R$ 999,00 </td>
                                  <td className="botao1"> <StyledButtonAdm style={{fontFamily:"MontserratBold", width:"9.5em", fontSize:".7em"}} cor="vermelho"> Saiu Para Entrega </StyledButtonAdm> </td>
                                  ...
                                  <td className="botao4"> <StyledButtonAdm style={{ fontFamily:"MontserratBold", width:"7.5em"}}  cor="vermelho"> Ver Itens </StyledButtonAdm> </td>
                              </tr>
                              <tr> 
                                  <td style={{paddingLeft:"1em"}}> 1 </td>
                                  <td> Grand theft Auto 5 </td>
